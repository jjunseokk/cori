...
// 이메일 인증
const emailCertification = (email: string) => {
  return AxiosConfig.post("/users/emailCertification", {email});
};
...
export { showJoin, showLogin, getUser, updateProfile, emailCertification };
